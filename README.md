...
An optional Chrome extension generates noise from your **real browser** — making decoy traffic even harder to distinguish from your actual browsing. The extension is maintained in a separate repository:

**[poisson-extension](https://github.com/Daring-Designs/poisson-extension)** — installation instructions, source code, and releases.
